`timescale 1ns / 1ps
module alu_s(a0,a1,a2,a3,b0,b1,b2,b3,f0,f1,f2,f3,carry_out,s0,s1,s2);
input a0,a1,a2,a3,b0,b1,b2,b3,s0,s1,s2;
output f0,f1,f2,f3,carry_out;
wire t0,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16,t17,t18,t19,t20,t21,t22,t23,t24,t25,t26,t27,t28,t29,t30;

rp_a R1(.a0(a0),.b0(b0),.a1(a1),.b1(b1),.a2(a2),.b2(b2),.a3(a3),.b3(b3),.ca_o(carry_out),.y0(t0),.y1(t1),.y2(t2),.y3(t3));
...
eightto1mux e4(.i0(t3),.i1(t7),.i2(t11),.i3(),.i4(t18),.i5(t22),.i6(t26),.i7(t30),.s0(s0),.s1(s1),.s2(s2),.f(f3));
